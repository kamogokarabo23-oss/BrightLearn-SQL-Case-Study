---Bright Coffee Sales Analysis by Product, Time, and Location
---This syntax provides a breakdown of revenue by product category, store location, and time of day.
---It uses the original time classification logic and includes temporal and categorical dimensions.
